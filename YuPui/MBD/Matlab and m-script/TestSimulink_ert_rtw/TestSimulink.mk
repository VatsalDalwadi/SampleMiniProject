###########################################################################
## Makefile generated for Simulink model 'TestSimulink'. 
## 
## Makefile     : TestSimulink.mk
## Generated on : Thu Apr 19 12:18:11 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TestSimulink.elf
...
MODELREF_LINK_RSPFILE_NAME = TestSimulink_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TestSimulink.elf
...
DEFINES_STANDARD = -DMODEL=TestSimulink -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/TestSimulink_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/TestSimulink_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/TestSimulink_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<

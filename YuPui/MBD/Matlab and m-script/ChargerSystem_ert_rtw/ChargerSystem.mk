###########################################################################
## Makefile generated for Simulink model 'ChargerSystem'. 
## 
## Makefile     : ChargerSystem.mk
## Generated on : Mon Apr 16 17:18:26 2018
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/ChargerSystem.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/fabricek/DOCUME~1/GitHub/SAMPLE~1/YuPui/MBD/MATLAB~1
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = ChargerSystem_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ChargerSystem.elf
...
DEFINES_STANDARD = -DMODEL=ChargerSystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/ChargerSystem_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.S.o : $(START_DIR)/ChargerSystem_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/ChargerSystem_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
